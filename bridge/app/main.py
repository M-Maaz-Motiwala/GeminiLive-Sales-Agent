...
def _is_did_exten(exten: Optional[str]) -> bool:
...
class GeminiLiveBridge:
    ...
    async def _handle_stasis_start(self, event: dict) -> None:
        ...
        try:
            ...
            dialed_raw = dialplan.get("exten")
            dialed_did: Optional[str] = None
            dialed_extension: Optional[str] = None
            if dialed_raw and _is_did_exten(str(dialed_raw)):
                dialed_did = str(dialed_raw)
            else:
                dialed_extension = dialed_raw
